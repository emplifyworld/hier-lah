...
A paid LinkedIn proximity tool that lets users see who's visiting their city and arrange meet-ups privately
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "232448306+emplifyworld@users.noreply.github.com"
  git config user.name "emplifyworld"
  ```
